...
(cl:defmethod cl:initialize-instance :after ((m <DriveToTarget-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveToTarget-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_robot-srv:<DriveToTarget-request> is deprecated: use my_robot-srv:DriveToTarget-request instead.")))

(cl:ensure-generic-function 'linear_x-val :lambda-list '(m))
(cl:defmethod linear_x-val ((m <DriveToTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot-srv:linear_x-val is deprecated.  Use my_robot-srv:linear_x instead.")
  (linear_x m))

(cl:ensure-generic-function 'angular_z-val :lambda-list '(m))
(cl:defmethod angular_z-val ((m <DriveToTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot-srv:angular_z-val is deprecated.  Use my_robot-srv:angular_z instead.")
  (angular_z m))
...
(cl:defmethod cl:initialize-instance :after ((m <DriveToTarget-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveToTarget-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_robot-srv:<DriveToTarget-response> is deprecated: use my_robot-srv:DriveToTarget-response instead.")))

(cl:ensure-generic-function 'msg_feedback-val :lambda-list '(m))
(cl:defmethod msg_feedback-val ((m <DriveToTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot-srv:msg_feedback-val is deprecated.  Use my_robot-srv:msg_feedback instead.")
  (msg_feedback m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DriveToTarget-response>)))
  ...
  "my_robot/DriveToTargetResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveToTarget-response)))
  "Returns string type for a service object of type 'DriveToTarget-response"
  "my_robot/DriveToTargetResponse")
